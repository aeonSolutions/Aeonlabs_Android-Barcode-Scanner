...
//**************************************************************************************************
    ...
    public String sendPostRequest(String requestURL,
        ...
        try {
            ...
            response= sb.toString();
            if(connectionResponseCode == 200 && response.equals("")){
                response= "{'error':true,'message':'"+activity.getResources().getString(R.string.commServer_check_internet)+" (200 OK null)'}";
                //Toast.makeText(context.this, "File Upload Complete.", Toast.LENGTH_SHORT).show();
            }else if(connectionResponseCode != 200 ){
                response= "{'error':true,'message':'"+activity.getResources().getString(R.string.commServer_check_internet)+"("+connectionResponseCode+" "+connectionResponseMessage+")'}";
            }
    ...
    public String sendGetRequest(String requestURL, Activity activity) {
        ...
        try {
            ...
            CrashReports crashReports = new CrashReports();
            crashReports.SaveCrash(e, activity);
            response= "{'error':true,'message':'"+activity.getResources().getString(R.string.commServer_check_internet)+" ("+e.getMessage().toString()+")'}";
        }finally {
            if (conn != null){
                conn.disconnect();
            }else{
