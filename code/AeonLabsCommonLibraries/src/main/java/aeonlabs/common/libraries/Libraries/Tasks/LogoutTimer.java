package aeonlabs.common.libraries.Libraries.Tasks;
...
public class LogoutTimer {
        ...
        static final int LOGOUT_TIME = SessionData.IdleLogOut.IdleLogoutTimeOut*60*1000; // delay in milliseconds i.e. 5 min = 300000 ms or use timeout argument
