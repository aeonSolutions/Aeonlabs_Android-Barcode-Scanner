package aeonlabs.common.libraries.checkSums;

import androidx.annotation.NonNull;

/**
 * Code adapted from here: https://github.com/NordicSemiconductor/Android-BLE-Common-Library
 *
...
public final class CRC16 {
    private static int polymonial; //0x1021
    private static int initialValue;//0x0000

    public CRC16(int poly, int initVal) {
        polymonial= poly;
    ...
    public static int CCITT_Kermit(@NonNull final byte[] data, final int offset, final int length) {
        return CRC(polymonial, initialValue, data, offset, length, true, true, 0x0000);
    }
