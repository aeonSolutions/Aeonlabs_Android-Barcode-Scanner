package aeonlabs.barcodescanner.home.activity;
...
import aeonlabs.barcodescanner.home.R;
import aeonlabs.barcodescanner.home.database.SettingsDatabaseHelper;
import aeonlabs.barcodescanner.home.model.SettingsDB;
...
public class WelcomeActivity extends ActivityBase  implements ActivityBaseObservable {
    ...
    private Boolean paymentServiceDone=false;
    private Boolean contactsDone=false;

    private int GOOGLE_SIGN_POS=3;
    private int PHONE_CONTACTS_POS=4;
    private int PAYMENT_SERVICE_POS=5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPager = (AeonLabsViewPager) findViewById(R.id.view_pager);
